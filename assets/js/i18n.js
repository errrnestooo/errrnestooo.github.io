(function(){
  ...
  const translations = {
    zh: {
      ...
      "os.hero.kicker": "数字记忆宫殿 / 私人操作系统",
      "os.hero.title": "Ernest OS",
      "os.hero.copy": "一个安静的仪表盘，用来保存一段仍在移动的人生：新加坡、列车、电影、书、钱、工作、渴望、路线，以及家的缓慢建筑。",
      "os.thesis.label": "当前命题",
      "os.thesis": "足够扎根以归属，足够鲜活以继续移动。",
      "os.overview": "人生概览",
      "os.profile": "人格剖面",
      "os.geography": "情感地理",
      "os.timeline": "人生时间线",
      ...
      "os.quiet": "静音模式",
      "os.age": "当前年龄",
      "os.lifeProgress": "人生进度",
      "os.lifeProgress.note": "以 80 年寿命计算",
      "os.birthday.note": "根据生日 1996-01-19 自动计算",
      "os.singaporeDays": "在新加坡的天数",
      "os.countries": "去过的国家",
      "os.flights": "飞行次数",
      "os.trains": "列车段数",
      "os.books": "读过的书",
      "os.films": "看过的电影",
      "os.writingEntries": "写作记录",
      "os.blood": "献血次数",
      "os.scaq": "SCAQ 进度",
      "os.networth": "净资产",
      "os.quiet.quote": "我是否更扎根了，同时仍然保持鲜活？"
    },
    en: {
      "nav.home": "Home",
      "nav.diary": "Diary",
      ...
      "os.hero.kicker": "Digital memory palace / private operating system",
      "os.hero.title": "Ernest OS",
      "os.hero.copy": "A quiet dashboard for a life in motion: Singapore, trains, films, books, money, work, longing, routes, and the slow architecture of home.",
      "os.thesis.label": "Current thesis",
      "os.thesis": "Rooted enough to belong. Alive enough to keep moving.",
      "os.overview": "Life Overview",
      "os.profile": "Personality Profile",
      "os.geography": "Emotional Geography",
      "os.timeline": "Life Timeline",
      "os.writing": "Writing & Themes",
      "os.trajectory": "Future Trajectory",
      "os.taste": "Taste Profile",
      "os.movement": "Movement Archive",
      "os.finance": "Financial OS",
      "os.quiet": "Quiet Mode",
      "os.age": "Current age",
      "os.lifeProgress": "Life progress",
      "os.lifeProgress.note": "assuming an 80-year lifespan",
      "os.birthday.note": "calculated from birthday 1996-01-19",
      "os.singaporeDays": "Days in Singapore",
      "os.countries": "Countries visited",
      "os.flights": "Flights taken",
      "os.trains": "Train segments",
      "os.books": "Books read",
      "os.films": "Films watched",
      "os.writingEntries": "Writing entries",
      "os.blood": "Blood donations",
      "os.scaq": "SCAQ progress",
      "os.networth": "Net worth",
      "os.quiet.quote": "Did I become more rooted without becoming less alive?"
    }
  };
